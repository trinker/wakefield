...
x <- "age ; animal , pet ; answer ; area ; birth , dob ; car ; children ; coin ;
color , primary ; date_stamp ; death , died ; dice ; dna ; dummy ; education ; employment ; eye ;
gender , sex ; gpa , grade , grade_letter ; group ; hair ; height , height_cm , height_in ; income ;
iq ; language ; level ; likert , likert_5 , likert_7 ; lorem_ipsum , paragraph ; lower , lower_factor ,
upper , upper_factor ; marital ; military ; month ; name ; normal , normal_round ; political ;
race ; sat ; sentence ; smokes ; speed , speed_kph , speed_mph ; state ; string ; valid ; year ;
zip_code"
...
blanks <- rep("", ncols * (ceiling(length(vect)/ncols) - length(vect)/ncols))

matrix(c(sprintf("%s", vect), blanks), ncol=ncols) %>%
    xtable() %>%
