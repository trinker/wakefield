...
opts_knit$set(self.contained = TRUE, cache = FALSE)
```
...
upper , upper_factor ; marital ; month ; name ; normal , normal_round ; political ; race ; sat ;
sentence ; smokes ; speed , speed_kph , speed_mph ; state ; string ; valid ; year ; zip_code"
