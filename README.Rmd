...
death , died ; dice ; dna ; dummy ; education ; empoyment ; eye ; gpa , grade , grade_letter ; grade_level ;
...
speed_kph , speed_mph ; state ; string ; valid ; year ; zip_code"
...
matrix(c(sprintf("<code>%s</code>", vect), blanks), ncol=4) %>%
    xtable() %>%
